...
class Preprocesser:
    ...
    def align_face(self, img, lm, output_size=1024):
        ...
        # Crop.
        border = max(int(np.rint(qsize * 0.3)), 3)     ##### EDITED 0.1 and 3
    ...
    def crop(self, img_np_list, still=False, xsize=512):    # first frame for all video
        ...
        #     extended_crop_height = int(crop_height * 1.5)
            
        #     clx = max(center_y - extended_crop_height // 2, 0)
        #     crx = min(center_y + extended_crop_height // 2, img_np.shape[0] - 1)
        #     cly = max(center_y - extended_crop_height // 2, 0)
        #     cry = min(center_y + extended_crop_height // 2, img_np.shape[0] - 1)

        # if still:
        #     # Extend crop size vertically
        #     crop_height = cry - cly
        #     crop_center_y = (cry + cly) // 2
        #     extended_crop_height = int(crop_height * 1.5)  # Adjust multiplier as needed
        #     cly = crop_center_y - extended_crop_height // 2
        #     cry = cly + extended_crop_height
