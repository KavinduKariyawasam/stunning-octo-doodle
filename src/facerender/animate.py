...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, preprocess='crop', img_size=256):
        ...
        an_end = time.perf_counter()

        print(f"Time for the animate part1 {an_end - an_st} seconds")
        ...
        imageio.mimsave(path, result,  fps=float(20))
        ...
        frames = frame_num 
        end_time = start_time + frames*1/20*1000
